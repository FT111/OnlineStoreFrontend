...
<div class="flex flex-row w-full md:p-4 p-2 h-screen gap-2">
	...
	<div class="flex flex-col grow h-full items-center justify-center">
		...
		<Card class="flex flex-col justify-between basis-7/12 md:p-16 md:px-4 p-8 md:w-2/3 gap-8 sm:w-4/5 w-full bg-none border-0 shadow-none rounded-2xl items-center">
