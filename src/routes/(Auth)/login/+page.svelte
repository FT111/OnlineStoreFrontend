		...
		<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
			<defs>
				<pattern id="bg" patternUnits="userSpaceOnUse" width="80" height="40" stroke-width="1.5" stroke="currentColor" fill="none" >
					<path class="translate-x-10 stroke-slate-600/50" stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
...
<!--	Form -->
	<div class="flex flex-col grow h-full items-center justify-center">
		...
		<Card class="flex flex-col justify-between basis-7/12 md:p-16 md:px-10 p-8 w-fit border-slate-200/60 shadow-none rounded-2xl items-center">
		...
		<p class="mt-16 font-semibold text-xl underline decoration-2 decoration-accent/40">Or Sign up</p>
