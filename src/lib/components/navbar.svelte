...
<nav class="fixed top-0 z-50 w-screen">
	...
	<div bind:this={navElement}  class="align-center items-center justify-between
                 flex flex-row p-3 sm:p-5 sm:px-8 px-4 h-16 gap-5 bg-primary //border-t-accent text-white
